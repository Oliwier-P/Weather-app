    ...
    <>
      ...
      <div className='main-container wrap-flex' >
        ...
        <div className='fav-cities' >
          ...
          <input type='text' placeholder='Search city' className='search-city' onChange={(e) => setCity(e.target.value)} />
          <button className='search-button' onClick={FetchData} >Check</button>
          <CityBox name={city} temp={weather?.temp_c} icon={weather?.icon} />
        </div>

        <div className='weather-div wrap-flex' >
          <div className='weather-div-names' >{city}</div>
          <WeatherNow 
